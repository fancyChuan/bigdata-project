...
import static cn.fancychuan.appclient.Utils.getRandomChar;
...
public class AppMain {
        ...
        for (int i = 0; i < loop_len; i++) {
            ...
            switch (flag) {
                ...
                case (1) :
                    ...
                    logger.info(millis + "|" + json.toJSONString()); //控制台打印
                    break;
            }
            try {
                Thread.sleep(delay);
    ...
    private static AppStart generateStart() {
        ...
        appStart.setMid(s_mid + ""); //设备id
        s_mid ++;
        appStart.setUid(s_uid + ""); // 用户id
        s_uid ++;
        appStart.setVc("" + rand.nextInt(20)); // 程序版本号 5,6等
        appStart.setVn("1." + rand.nextInt(4) + "." + rand.nextInt(10)); //程序版本名 v1.1.1
        appStart.setOs("8." + rand.nextInt(3) + "." + rand.nextInt(10)); // 安卓系统版本
        appStart.setEn("start"); //设置日志类型
        int flag = rand.nextInt(3); // 语言  es,en,pt
        switch (flag) {
            case (0):
                appStart.setL("es");
                break;
        ...
        // gmail
        appStart.setG(Utils.getRandomCharAndNumr(8) + "@gmail.com");
        // 屏幕宽高 hw
        flag = rand.nextInt(4);
        switch (flag) {
            case 0:
    ...
    private static JSONObject generateComFields() {
        ...
        // 嵌入sdk的版本
        appBase.setSv("V2." + rand.nextInt(10) + "." + rand.nextInt(10));// gmail
        appBase.setG(Utils.getRandomCharAndNumr(8) + "@gmail.com");
        // 屏幕宽高 hw
        flag = rand.nextInt(4);
        switch (flag) {
            case 0:
    ...
    private static JSONObject generateBackground() {
        AppActive_background appActive_background = new AppActive_background();// 启动源
        int flag = rand.nextInt(3) + 1;
    ...
    private static JSONObject generateComment() {
        ...
        comment.setContent(Utils.getCONTENT());
